...
import { Flame, Info, PiggyBank, Plus, Share2, Sliders } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "Push Daily — Daily push-up targets with your friends" },
      {
        name: "description",
        content:
          "Set your own daily push-up amount and frequency, log reps as you go, bank extra progress, and invite friends to your team.",
      },
